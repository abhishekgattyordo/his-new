...
//     setFilterPosition({
//       top: rect.bottom + window.scrollY + 8, // 8px offset from button
...
//           <a href="#" className={`flex items-center gap-3 px-3 py-2.5 text-slate-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:text-blue-700 rounded-xl transition-all duration-200 group ${sidebarCollapsed ? 'justify-center' : ''}`}>
...
//           {/* Billing Button (replaced Patient Search) */}
//           <a href="#" className={`flex items-center gap-3 px-3 py-2.5 text-slate-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:text-blue-700 rounded-xl transition-all duration-200 group ${sidebarCollapsed ? 'justify-center' : ''}`}>
//             <div className="w-8 h-8 bg-slate-100 group-hover:bg-white rounded-lg flex items-center justify-center flex-shrink-0">
    ...
    <div className="h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex overflow-hidden">
      ...
      `}>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-1">
          ...
          {/* Billing Button - Navigates to billing page */}
          <button 
