...
// import { doctorsApi } from "@/lib/api/doctors"; // adjust path if needed
...
//     // Map the API response to your Patient type
//     return patientsData.map((p: any) => ({
//       id: p.patient_id,
//       name: p.full_name_en,
//       age: calculateAge(p.dob), // implement calculateAge function
//       gender: p.gender,
//       phone: p.phone,
//       email: p.email,
...
//   // Mock patients for existing patient selection
...
//       id: String(doc.id),
//       name: `${doc.firstName} ${doc.lastName}`, // ✅ FIX HERE
//       specialization: doc.specialty,            // ✅ FIX HERE
//       availableSlots: [],
//     }));

   

//     setDoctors(doctorList); // ✅ correct
//   } catch (error) {
...
//                   className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 flex items-center justify-center gap-2 w-full xs:w-auto"
//                 >
...
//                 <p className="text-sm text-gray-500">Filter options (to be implemented)</p>
//               </div>
//             )}
...
//   doctors={doctors}
//   onSearchPatientByPhone={searchPatientByPhone}   // ✅ pass the function
