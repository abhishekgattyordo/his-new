    ...
    <div className="bg-[#f6f7f8] min-h-screen font-[Manrope] text-slate-900 antialiased flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-slate-200 px-4 md:px-10 py-3 flex items-center justify-between whitespace-nowrap">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <button className="text-slate-500 hover:text-[#137fec] text-sm font-medium leading-normal transition-colors">
              Dashboard
            </button>
      ...
      <main className="flex-1 flex flex-col max-w-[1440px] mx-auto w-full px-4 md:px-6 py-6 gap-6">
        ...
        <div className="flex flex-wrap items-center gap-2 text-sm">
          <button className="text-slate-500 hover:text-[#137fec] transition-colors">
            Patients
          </button>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          <div className="flex flex-col sm:flex-row gap-5 items-start sm:items-center">
            <div 
              className="w-20 h-20 rounded-full bg-slate-100 bg-center bg-cover border-4 border-white shadow-md"
              style={{backgroundImage: `url('https://lh3.googleusercontent.com/aida-public/AB6AXuB5NyXWGt958X_JVA94a3t064KH90qwLTeZsvjESLrnjVznz91G1WjnJeXapWznCcWTfkPQrJ7f8MNPLCkv9vRSQ3IbgxWa1PU44H9WZISD0Old0F2kgIGYqdjSaCqXcetmrkQuPFCUEUgPlA8Rqb5yHqAuqucUONXJeVm7jjTw7dOWBv_sjtyjhUE0wLE6pnBPOKDLUk7QBy12Z4c46ct1cAvxSHNXh6Di3y_CVbql3BtgF1hYJq4I0HjmkYsTrkWOCnx53dk9Lr4')`}}
            />
            <div className="flex flex-col gap-2 flex-1">
              <div className="flex flex-wrap items-center gap-3">
                <h1 className="text-2xl font-bold text-slate-900 leading-tight">Jane Doe</h1>
                <span className="px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 text-xs font-bold uppercase tracking-wider border border-emerald-100">
                  Active
                </span>
              </div>
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-slate-600 text-sm">
                <span className="flex items-center gap-1.5">
                  ...
                  <span className="font-medium">ID: #9821039</span>
                </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start h-full">
          ...
          <div className="lg:col-span-8 xl:col-span-9 flex flex-col gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 min-h-[600px] flex flex-col overflow-hidden">
              {/* Tabs - Now with Vitals between Current Visit and Prescriptions */}
              ...
              {/* Content Body - Dynamic based on active tab */}
