...
//                     {
//                       label: "OP Dispense",
//                       path: "/pharmacy/op-dispense",
//                       icon: ClipboardList,
//                     },
//                     {
//                       label: "IP Issue",
//                       path: "/pharmacy/ip-issue",
//                       icon: Package,
//                     },
//                     {
//                       label: "Stock Adjust",
...
//                       key={action.label}
//                       href={action.path}
//                       className="flex flex-col items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 shadow-sm hover:shadow-md hover:border-green-300 dark:hover:border-green-700 transition-all text-center group"
//                     >
//                       <action.icon
//                         size={24}
