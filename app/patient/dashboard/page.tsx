...
//       setDebugInfo(prev => prev + "\nFetching: /api/appointments/patient/" + patientId);
...
//       if (data.success) {
//         console.log("✅ Appointments received:", data.data.length);
//         setDebugInfo(prev => prev + "\nAppointments count: " + data.data.length);
...
//             <div className="mb-4 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg text-xs font-mono overflow-auto max-h-40">
//               <pre>{debugInfo}</pre>
//             </div>
//           )}
