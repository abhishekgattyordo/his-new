...
export default function HelpDeskPage() {
  ...
  const doctors: Doctor[] = [
    {
      ...
      availableSlots: [
        ...
        { date: "2024-01-16", times: ["09:00", "10:30", "13:00", "14:30"] },
        { date: "2024-01-17", times: ["08:00", "09:30", "11:00", "15:00", "16:00"] },
      ],
    },
    {
      id: "DOC002",
      ...
      availableSlots: [
        { date: "2024-01-15", times: ["08:30", "10:00", "11:30", "13:00", "14:30", "16:00"] },
        { date: "2024-01-16", times: ["09:00", "10:00", "14:00", "15:30"] },
        { date: "2024-01-17", times: ["08:00", "09:00", "11:00", "13:00", "15:00"] },
      ],
    },
    {
      id: "DOC003",
      ...
      availableSlots: [
        ...
        { date: "2024-01-16", times: ["09:30", "11:00", "13:30", "15:00"] },
        { date: "2024-01-17", times: ["08:30", "10:00", "12:00", "14:00", "16:00"] },
      ],
    },
  ];
  ...
  // Get filtered appointments based on applied filters
  const getFilteredAppointments = () => {
    ...
    // Bill search (using patient ID as bill number)
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex overflow-hidden">
      ...
      {/* Sidebar Component */}
     <HelpDeskSidebar
  isOpen={mobileMenuOpen} // controls mobile menu visibility
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className={`flex-1 px-3 py-2 rounded-lg flex items-center justify-center gap-1 ${tempFilters.dateSort === 'asc' ? 'bg-blue-50 text-blue-700' : 'bg-slate-50 text-slate-600 hover:bg-slate-100'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`flex-1 px-3 py-2 rounded-lg flex items-center justify-center gap-1 ${tempFilters.dateSort === 'desc' ? 'bg-blue-50 text-blue-700' : 'bg-slate-50 text-slate-600 hover:bg-slate-100'
                            }`}
                        >
                  ...
                  <div className="p-4 space-y-3 bg-white">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`flex-1 px-3 py-2 rounded-lg flex items-center justify-center gap-1 ${tempFilters.patientSort === 'asc' ? 'bg-blue-50 text-blue-700' : 'bg-slate-50 text-slate-600 hover:bg-slate-100'
                          }`}
                      >
                        <span className="material-icons text-sm">arrow_upward</span>
                      ...
                      <button
                        ...
                        className={`flex-1 px-3 py-2 rounded-lg flex items-center justify-center gap-1 ${tempFilters.patientSort === 'desc' ? 'bg-blue-50 text-blue-700' : 'bg-slate-50 text-slate-600 hover:bg-slate-100'
                          }`}
                      >
                        <span className="material-icons text-sm">arrow_downward</span>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className={`flex-1 px-3 py-2 rounded-lg flex items-center justify-center gap-1 ${tempFilters.ageSort === 'asc' ? 'bg-blue-50 text-blue-700' : 'bg-slate-50 text-slate-600 hover:bg-slate-100'
                            }`}
                        >
                          <span className="material-icons text-sm">arrow_upward</span>
                        ...
                        <button
                          ...
                          className={`flex-1 px-3 py-2 rounded-lg flex items-center justify-center gap-1 ${tempFilters.ageSort === 'desc' ? 'bg-blue-50 text-blue-700' : 'bg-slate-50 text-slate-600 hover:bg-slate-100'
                            }`}
                        >
                          <span className="material-icons text-sm">arrow_downward</span>
                  ...
                  <div className="p-4 space-y-3 bg-white">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`flex-1 px-3 py-2 rounded-lg flex items-center justify-center gap-1 ${tempFilters.doctorSort === 'asc' ? 'bg-blue-50 text-blue-700' : 'bg-slate-50 text-slate-600 hover:bg-slate-100'
                          }`}
                      >
                        <span className="material-icons text-sm">arrow_upward</span>
                        <span className="text-xs">A-Z</span>
                      ...
                      <button
                        ...
                        className={`flex-1 px-3 py-2 rounded-lg flex items-center justify-center gap-1 ${tempFilters.doctorSort === 'desc' ? 'bg-blue-50 text-blue-700' : 'bg-slate-50 text-slate-600 hover:bg-slate-100'
                          }`}
                      >
                        <span className="material-icons text-sm">arrow_downward</span>
                        <span className="text-xs">Z-A</span>
                  ...
                  <div className="p-4 space-y-2 bg-white">
                    {['pending', 'confirmed', 'completed', 'cancelled'].map((status) => (
                      <button
                        ...
                        className={`w-full px-4 py-3 rounded-lg flex items-center justify-between ${tempFilters.selectedStatuses.includes(status) ? 'bg-blue-50 text-blue-700' : 'hover:bg-slate-50 text-slate-700'
                          }`}
                      >
                  ...
                  <div className="p-4 space-y-2 bg-white">
                    {['checkup', 'consultation', 'followup', 'emergency'].map((type) => (
                      <button
                        ...
                        className={`w-full px-4 py-3 rounded-lg flex items-center justify-between ${tempFilters.selectedTypes.includes(type) ? 'bg-blue-50 text-blue-700' : 'hover:bg-slate-50 text-slate-700'
                          }`}
                      >
