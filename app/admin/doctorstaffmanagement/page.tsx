...
//     avatarUrl:
//       "https://lh3.googleusercontent.com/aida-public/AB6AXuDYG-ZyNFl6ZSNyh_-ZR5p_ZV0hqudz7WpM8SS1lAg0Ch_MIzu3xckhjkdCRdF60NGqYlDmmJGV9YD_Q6D6ZcyRqBMS6xWvWtAPAjiRLQv_vsRvCazjkm4q86njQIyUw3Tzq9GQLhgLnOYIeHUl-GcqwCz-OyH7wrtjKrrLukrpZC7e9hbEpmdVR4vqk_KUxRyRTaFQYqon_j1R3M6opgLFuxm-yfiZ8jz63FKcvfXjIryx1RplrdlLI3BN4QwumiOTg0So1bpS5t4",
...
//     id: 2,
//     name: "Dr. Mark Sloan",
//     email: "m.sloan@hospital.com",
//     avatarUrl:
//       "https://lh3.googleusercontent.com/aida-public/AB6AXuCK5LL2o7DbKXxZYvg4p7OA4-gyxi1VVBxyKGJpy20fi8UKS-2lQiZ7-pnVg7wMJcJHRCEb-pk3Zhqk1iGRk_yiOx_CT2OVLLmRsUGh0_ajyQ_AlQqBD-nw6VYXMdqWQ5QbKedCUm28CpZTSDIiCUFILDU6nM2VKN6gia7pO-uQeXlaLqrWkhGd_PRfQkh2J0kWpLA_GGHdJQPE6umcttTJBoecsa6q_orjiFWTbkzIUr_CI4pA9Wojmp57oo3TvWODMwElOaUNUTM",
//     specialty: "Surgery",
//     specialtyColor:
//       "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300",
//     department: "General Surgery",
//     contact: "+1 (555) 012-7890",
//     dateJoined: "Mar 22, 2019",
//     status: "on-leave",
...
//     id: 3,
//     name: "Dr. Lisa Cuddy",
//     email: "cuddy.l@hospital.com",
//     avatarUrl:
//       "https://lh3.googleusercontent.com/aida-public/AB6AXuC6WAaM92IqhKY2HNTYbZGx6x-LZM9wFN2TQWJW8KEKuDAKfL2D-zYnjxc3IbBjRILbmi7scE7sCQA4CXP5mONw9HfYRnhjH2z5QS3xGn1zNOWCwrXvIcYVDL9exTyHIVcIWe-RFHj7QcVrQYm3r4Nq9Dzla6xb9oewAuRGQ3HgCiZ4wK8cXBgFwOXgvT5FAL3wAbSQQMdCErikTti3kGdd-m7E85ImRnhKuGSxhXDNjpBxRoXxMbPNxXuGh_9caGT1kd-rwmiJn0M",
//     specialty: "Diagnostics",
//     specialtyColor:
//       "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300",
//     department: "Diagnostics",
//     contact: "+1 (555) 012-4567",
//     dateJoined: "Nov 05, 2018",
//     status: "active",
//     statusColor: "text-green-700 dark:text-green-400",
//   },
//   {
...
//     contact: "+1 (555) 012-5678",
//     dateJoined: "Jun 10, 2021",
//     status: "active",
//     statusColor: "text-green-700 dark:text-green-400",
//   },
//   {
...
//     avatarUrl:
//       "https://images.unsplash.com/photo-1594824434340-d2d9d2fc5b4c?w=150&h=150&fit=crop",
//     specialty: "Pediatrics",
//     specialtyColor:
//       "bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-300",
//     department: "Pediatrics",
//     contact: "+1 (555) 012-6789",
//     dateJoined: "Aug 22, 2019",
//     status: "on-leave",
//     statusColor: "text-amber-700 dark:text-amber-400",
//   },
//   {
...
// // Stats data with professional icons
// const statsData = [
//   {
//     title: "Total Doctors",
//     value: "124",
...
// // Filter data
// const filtersData = [
//   { label: "All Specialties", isActive: true },
//   { label: "Cardiology", isActive: false },
//   { label: "Pediatrics", isActive: false },
//   { label: "Neurology", isActive: false },
//   { label: "Surgery", isActive: false },
//   { label: "Orthopedics", isActive: false },
// ];
...
// // Reusable ColumnFilter component (for text/select)
// interface ColumnFilterProps {
//   column: string;
//   placeholder?: string;
//   options?: string[]; // for dropdown filter
...
// // Date Range Filter Component (for date columns)
...
//   // Helper to parse date strings like "Jan 15, 2020" to comparable Date objects
...
//     // Date range filter for dateJoined
//     const dateRange = dateFilters.dateJoined;
//     let matchesDateRange = true;
//     if (dateRange && (dateRange.from || dateRange.to)) {
//       const doctorDate = parseDate(doctor.dateJoined);
//       if (dateRange.from) {
...
//     return matchesSearch && matchesSpecialty && matchesColumnFilters && matchesDateRange;
//   });
...
//                       Central hub for practitioner credentials, status updates, and administrative workflow.
//                     </p>
//                   </div>
...
//                             whitespace-nowrap
//                             ${
//                               selectedSpecialty === filter.label
...
//                           {/* Hover arrow indicator for inactive filters */}
//                           {!(selectedSpecialty === filter.label) && (
...
//                                   <ColumnFilter
//                                     column="specialty"
//                                     options={Array.from(new Set(doctorsData.map(d => d.specialty)))}
//                                     onFilter={(col, val) => {
//                                       setColumnFilters(prev => {
//                                         const filtered = prev.filter(f => f.column !== col);
//                                         return val ? [...filtered, { column: col, value: val }] : filtered;
//                                       });
//                                     }}
//                                     currentValue={columnFilters.find(f => f.column === "specialty")?.value}
//                                   />
//                                 </div>
//                               </th>
//                               <th className="px-3 md:px-4 py-3 text-slate-900 dark:text-white text-xs md:text-sm font-bold uppercase tracking-wider whitespace-nowrap border-r border-slate-300 dark:border-slate-700">
...
//                                   <ColumnFilter
//                                     column="department"
//                                     options={Array.from(new Set(doctorsData.map(d => d.department)))}
//                                     onFilter={(col, val) => {
//                                       setColumnFilters(prev => {
//                                         const filtered = prev.filter(f => f.column !== col);
//                                         return val ? [...filtered, { column: col, value: val }] : filtered;
...
//                                       });
//                                     }}
//                                     currentValue={columnFilters.find(f => f.column === "contact")?.value}
//                                   />
//                                 </div>
//                               </th>
//                               <th className="px-3 md:px-4 py-3 text-slate-900 dark:text-white text-xs md:text-sm font-bold uppercase tracking-wider whitespace-nowrap border-r border-slate-300 dark:border-slate-700">
...
//       onClick={() => router.push(`/admin/doctorstaffmanagement/${doctor.id}`)} // Add this line
//     >
...
//                                 <td className="px-3 md:px-4 py-3 whitespace-nowrap border-r border-slate-200 dark:border-slate-700">
//                                   <span
//                                     className={`inline-flex items-center px-2 py-1 rounded-full text-xs md:text-sm font-medium ${doctor.specialtyColor}`}
//                                   >
//                                     {doctor.specialty}
//                                   </span>
//                                 </td>
...
//                         Showing 1 to {filteredDoctors.length} of {doctorsData.length} entries
//                       </span>
